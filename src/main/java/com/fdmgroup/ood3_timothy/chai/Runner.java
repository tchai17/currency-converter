...
/**
 * This is the main runner class used to execute all other classes to achieve
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Calls getListofTransactionsToExecute to return a list of transactions read
	...
	/**
	 * This method obtains the absolute path based on the current working directory
	 * of the project
	 * 
